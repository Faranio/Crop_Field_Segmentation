...
class TrainingPipeline:
    ...
    def initialize_datasets(self):
        lgblkb_tools.logger.info("Initializing datasets...")
    ...
    def initialize_data_loaders(self):
        lgblkb_tools.logger.info("Initializing dataloaders...")
    ...
    def initialize_model(self):
        lgblkb_tools.logger.info("Initializing model...")
    ...
    def initialize_tools(self, base_lr, max_lr):
        lgblkb_tools.logger.info("Initializing tools...")
        ...
        self.lr_scheduler = torch.optim.lr_scheduler.CyclicLR(
            ...
            max_lr=max_lr,
            step_size_up=1,
            step_size_down=len(self._dataset_train) // self.batch_size
        )
    ...
    def train(self, base_lr=0.000005, max_lr=0.005, num_epochs=50, print_freq=10):
        ...
        for epoch in range(num_epochs):
            ...
            del self.valid_coco_ds
            del self.valid_coco_evaluator
